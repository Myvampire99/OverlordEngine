...
class TransformComponent : public BaseComponent
{
	...
	DirectX::XMFLOAT4X4 m_World{}, m_WorldWithoutRotation{}, m_WorldWithOnlyPos{};//TODO: How to do this
...
public:
	...
	const DirectX::XMFLOAT4X4& GetWorldWithoutRotation() {
		
		auto worldWithoutRotation = DirectX::XMMatrixScaling(m_Scale.x, m_Scale.y, m_Scale.z) *
			DirectX::XMMatrixTranslation(m_Position.x, m_Position.y, m_Position.z);
		XMStoreFloat4x4(&m_WorldWithoutRotation, worldWithoutRotation);
		
		
		return m_WorldWithoutRotation; }
	const DirectX::XMFLOAT4X4& GetWorldWithOnlyPos() const { return m_WorldWithOnlyPos; }
